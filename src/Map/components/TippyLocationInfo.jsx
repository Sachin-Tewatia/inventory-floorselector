...
export const tippyLocationInfo = async (mapElementId) => {
  ...
  return `<div className="overlay-can-hide route-details flex flex-col gap-2  bg-[rgba(0,0,0,0.0)]  text-slate-200 rounded-md px-3 py-2">
            <div className="flex gap-2 font-light">
            <div className="distance flex flex-col items-center justify-center ">
            <div className="time font-medium" style="color:white ">${displayTitle}</div>
            <div className="time font-medium" style="color:white ">${finalDistance} KM</div>
            </div>
          </div>`;
};
...
export const tippyLocationInfofornotlandmark = (title) => {
  ...
  return `<div className="overlay-can-hide route-details flex flex-col gap-2 bg-[rgba(0,0,0,0.0)] text-slate-200 rounded-md px-3 py-2">
    <div className="flex gap-2 font-light justify-center items-center">
        <div className="distance flex gap-2 items-center justify-center">
            <div className="time font-medium" style="color:white">${title}</div>
        </div>
    </div>
    <div className="distance flex gap-2 items-center justify-center">
        <div className="time font-medium" style="color:white">${time} Min</div>
        <div className="time font-medium" style="color:white"> | </div>
        <div className="time font-medium" style="color:white">${distance} KM</div>
    </div>
</div>`;
};
...
//     if (isDriving) {
//       return (
//         `<div className="flex flex-col gap-2 justify-center bg-[rgba(0,0,0,0.3)] text-slate-100 backdrop-blur-sm px-2 py-1 rounded-md text-[10px]">
//           <div className="flex gap-2 font-light">
//            <div className="distance flex gap-2 items-center justify-center ">
//            <div className="w-[15px] h-[15px] object-contain"><svg viewBox="0 0 31 26" fill="none" xmlns="http://www.w3.org/2000/svg">
...
//           </svg></div>
//           <div className="time font-strong" style="color:white"> | </div>
//         <div className="time">${time} Min</div>
//         <div className="time font-strong" style="color:white"> | </div>
//       <div className="time">${distance} KM</div>
//       </div>
//       </div>
//     </div>`
//       );
...
export const tippyLocationInfoForData = (
  ...
  const renderContent = () => {
    ...
    if (isDriving) {
      return (
        `<div className="flex flex-col gap-2 justify-center ${blur} text-slate-100 backdrop-blur-sm px-2 py-1 rounded-md text-[10px]">
          <div className="flex gap-2 font-light">
           <div className="distance flex gap-2 items-center justify-center ">
           <div className="w-[15px] h-[15px] object-contain">
            <svg viewBox="0 0 31 26" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="time font-strong" style="color:${textColor}"> | </div>
        <div className="time" style="color:${textColor}">${time} Min</div>
        <div className="time font-strong" style="color:${textColor}"> | </div>
      <div className="time" style="color:${textColor}">${distance} KM</div>
      </div>
      </div>
    </div>`
      );
    ...
    if (tippyText === "Dev sthal mandir") {
      return (
        `<div className="flex flex-col gap-2 justify-center bg-[rgba(0,0,0,0.3)] text-slate-100 backdrop-blur-sm px-2 py-1 rounded-md text-[10px]">
          <div className="flex gap-2 font-light">
           <div className="distance flex gap-2 items-center justify-center ">
           <div className="w-[15px] h-[15px] object-contain"><svg width="283" height="283" viewBox="0 0 283 283" fill="none" xmlns="http://www.w3.org/2000/svg">
