...
export const ALL_TOWERS_SVGS = {
  0: {
    T1: "M849 667.669L848.5 339L866.5 330V322L872.5 319L881.5 321.5L886 319L931 338V343L949.5 350L955 348L1000.5 366.794V371.294L1019 379L1025 376.5L1071.5 395.5V401H1074V420H1076L1074.5 531L1073 680.5L1098 698V747.349L1057.5 761.5L849 667.669Z",
  },
  1: {
...
export const getFloorName = (tower, floor, upperUnit) => {
  ...
  if (
    (tower === "T7" || tower === "T10") &&
    (floor11.includes(floor) || floor12.includes(floor))
  ) {
